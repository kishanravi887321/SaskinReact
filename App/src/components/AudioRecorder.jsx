        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          {!isRecording ? (
            <Button
              ...
              className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full bg-gradient-to-br from-red-500 to-red-600 hover:from-red-400 hover:to-red-500 transition-all duration-200 touch-none select-none"
              disabled={recordingStatus === 'processing'}
            >
              <Mic className="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 text-white" />
            </Button>
          ) : (
            <div className="flex items-center gap-3 sm:gap-4">
              <Button
                onClick={togglePause}
                variant="secondary"
                className="w-14 h-14 sm:w-16 sm:h-16 rounded-full touch-none select-none"
              >
              ...
              <Button
                ...
                className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full bg-gradient-to-br from-gray-600 to-gray-700 hover:from-gray-500 hover:to-gray-600 touch-none select-none"
              >
                <Square className="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 text-white" />
              </Button>
            </div>
          )}
